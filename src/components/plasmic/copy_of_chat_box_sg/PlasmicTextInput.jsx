...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: tSPm0LoBpBYbm/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: jas9XikRgMhYa/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 8-M5790gK1Q09/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__hqDcI)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__cbLtf)}
                role={"img"}
              />
            ),
