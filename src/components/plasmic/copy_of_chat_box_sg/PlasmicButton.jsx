...
import sty from "./PlasmicButton.module.css"; // plasmic-import: FHsN5oHAGgn/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 8-M5790gK1Q09/icon
import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: 72xS4VPZ6czI5/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__vjI7Q)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon3Icon
                className={classNames(projectcss.all, sty.svg__t3G3P)}
                role={"img"}
              />
            ),
